...
public class StudentLogin extends javax.swing.JFrame {
    ...
    private void register() {
        ...
        try {
            if (service.checkDuplicateEmail(user.getEmail())) {
                ...
                service.insertUserSP(user.getUserID(), user.getFirstname(), user.getLastname(), user.getEmail());
                sendMain(user);
            }
        } catch (Exception e) {
    ...
    private void login() {
        ...
        try {
            ...
            if (user != null) {
                this.dispose();
                Studentpage page = new Studentpage(data.getEmail());
                page.show();
            } else {
