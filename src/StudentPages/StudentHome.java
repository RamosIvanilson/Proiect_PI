...
public class StudentHome extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        try {
            ...
            String sql = "SELECT image, denomination, university FROM scholarships ORDER BY published DESC";
            ...
            while(rs.next()) {
                ...
                panel.add(new CardPanel(new Model_Card(schImage, uni, sch, this.Email)));
            }
